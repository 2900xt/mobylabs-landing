    ...
    >
      <div className="max-w-7xl mx-auto px-2 py-2 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/app"
            className={`font-semibold transition-all duration-300 hover:scale-105 text-sm ${pathname === "/app"
          ...
          <Link
            href="/app/docs"
            className={`font-semibold transition-all duration-300 hover:scale-105 text-sm ${pathname === "/app/docs"
              ? "text-cyan-300 border-b-2 border-cyan-400"
              : "text-white/70 hover:text-white"
              }`}
          >
          ...
          <Link
            href="/app/logs"
            className={`font-semibold transition-all duration-300 hover:scale-105 text-sm ${pathname === "/app/logs"
              ? "text-cyan-300 border-b-2 border-cyan-400"
              : "text-white/70 hover:text-white"
              }`}
          >
          ...
          <Link
            href="/app/map"
            className={`font-semibold transition-all duration-300 hover:scale-105 text-sm ${pathname === "/app/map"
              ? "text-cyan-300 border-b-2 border-cyan-400"
              : "text-white/70 hover:text-white"
              }`}
          >
